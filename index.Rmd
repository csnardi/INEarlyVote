...
```
## {.tabset}
Inspired by [Michael McDonald](https://electproject.github.io/Early-Vote-2020G/index.html).
...
Indiana voters have cast **`r format(last(pull(IN_2020_Statewide, "Walk-inTOTAL")), big.mark =",")`** in-person early votes.
...
Indiana voters have cast **`r format(last(IN_2020_Statewide$MailedReturnedTOTAL), big.mark =",")`** mail ballots.
...
Indiana voters have requested **`r format(last(IN_2020_Statewide$MailTOTAL), big.mark =",")`** mail ballots.
